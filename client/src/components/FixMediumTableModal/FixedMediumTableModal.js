    ...
    return (
        <>
            ...
            <Draggable onDrag={handleDrag} handle=".table" defaultPosition={{ x: 300, y: 200 }} >
                ...
                <Button className="table-medium table text-center" style={{ backgroundColor: props.table.color }} onClick={handleShow}>Table Medium</Button>
            </Draggable>

            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title style={{ fontFamily: "monospace", fontSize: "20px" }}>Do you want to save this position? </Modal.Title>
                </Modal.Header>
